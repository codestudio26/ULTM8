...
describeIfDb('MembershipsModule + TransactionsModule — HTTP-level CRUD, purchase, and RLS', () => {
  ...
  it('resolves the paying Student\'s name even after their only RoleGrant at this School is revoked (Decision 113 regression)', async () => {
    ...
    // synchronously. Before Decision 113's fix, the name join was a Prisma
